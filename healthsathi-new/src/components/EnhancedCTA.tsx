...
export default function EnhancedCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-red-primary to-brand-red-dark">
        ...
        >
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 sm:gap-12">
            <div className="text-center">
              ...
              <div className="text-sm text-white/70">Reports Analyzed</div>
            </div>
            <div className="text-center">
