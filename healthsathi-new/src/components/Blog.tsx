    ...
    <section className="py-24 sm:py-32 bg-gray-50">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 flex justify-center">
          <Link
            href="/blog"
            className="rounded-md bg-brand-red-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-red-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-red-primary"
          >
            View All Articles
          </Link>
        </div>
